        ...
        steps {
          ...
          echo "Copying file from windows server to WINDOWS Server"
           ...
           withCredentials([
              ...
              sh "sshpass -p '${windowspass}' ssh Administrator@3.133.89.186 'powershell.exe netstat; Copy-Item -Path C:/Users/Administrator/Downloads/RecruitmentApp/Version1/* -Destination //3.145.211.146/test1/ -Force'"
