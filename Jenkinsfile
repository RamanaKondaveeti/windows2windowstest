    ...
    stages {
       ...
       stage ('Deploy to Server') {
        steps {
          ...
          sh "echo y | pscp -pw 'KSVoTE%3n3kiN=Jn36;ZHEdHm(JG*ptV' ${finalfile} Administrator@3.133.89.186:/Users/Administrator/Downloads/RecruitmentApp/Version1 -o StrictHostKeyChecking=no"
