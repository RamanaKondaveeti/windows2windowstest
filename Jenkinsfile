...
def finalfile ="${backup_folder}/${JOB_NAME}_$timestamp_${currentBuild.number}.apk"
       ...
       stage ('Backup apk'){
          steps {
            ...
            // Renaming apk file with app and build number    
              ...
              sh "mv ${project_folder}/*.apk ${backup_folder}/${JOB_NAME}_$timestamp_${currentBuild.number}.apk"
