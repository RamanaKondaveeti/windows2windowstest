        ...
        steps {
          ...
          echo "Copying file from windows server to WINDOWS Server"
           ...
           withCredentials([
              ...
              sh "sshpass -p '${windowspass}' ssh Administrator@3.133.89.186 'powershell.exe copy ${windowspath}/* username=Administrator password='NLTO6yfLIV)(Ku*f2f8cMXDY-fwLU4u?' //3.145.211.146/test1'"
